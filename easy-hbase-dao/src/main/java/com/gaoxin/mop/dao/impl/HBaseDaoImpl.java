package com.gaoxin.mop.dao.impl;
...
import com.gaoxin.mop.utils.HBaseUtil;
...
public class HBaseDaoImpl implements HBaseDao {
    ...
    @Override
    public <T> T get(String tableName, String rowKey, @Nullable List<ColumnInfo> columns, @Nullable List<ColumnInfo> filters, Class<? extends T> clazz) {
    ...
    @Override
    public List<String> getRowKeys(String tableName, String startRow, String endRow, Integer pageSize, String separate, Integer index) {
    ...
    @Override
    public List<ColumnInfo> getColumns(String tableName, String rowKey, String columnFamily, List<ColumnInfo> columns, List<ColumnInfo> filters) {
        HTable hTable = null;
    ...
    @Override
    public List<ColumnInfo> getColumns(String tableName, String rowKey, List<ColumnInfo> columns, List<ColumnInfo> filters) {
    ...
    @Override
    public <T> List<T> getList(String tableName, List<String> rowKeys, List<ColumnInfo> columns, List<ColumnInfo> filters, Class<? extends T> clazz) {
    ...
    @Override
    public <T> List<T> getList(String tableName, @Nullable List<ColumnInfo> columns, @Nullable List<ColumnInfo> filters, Class<? extends T> clazz) {
        return getList(tableName, columns, filters, null, null, clazz);
    }

    @Override
    public <T> List<T> getList(String tableName, List<ColumnInfo> columns, List<ColumnInfo> filters, String start, String end, Class<? extends T> clazz) {
        if (clazz == null) {
            return null;
        }
        HTable hTable = null;
    ...
    @Override
    public <T> List<T> getPageList(String tableName, String startRow, String endRow, Integer pageSize, Class<? extends T> clazz) {
        if (clazz == null) {
            return null;
        }
        HTable hTable = null;
    ...
    @Override
    public List<ColumnInfo> getColumnsByPage(String tableName, String rowkey, Integer pageNo, Integer pageSize, List<ColumnInfo> columns, List<ColumnInfo> filters) {
        HTable hTable = null;
        List<ColumnInfo> dataList = new ArrayList<>();
        try {
            hTable = (HTable) HBaseFactoryBean.getDefaultConnection().getTable(tableName);
    ...
    @Override
    public <T> List<T> getColumnObjList(String tableName, String rowKey, List<String> columns, Class<? extends T> clazz) {
        HTable hTable = null;
    ...
    @Override
    public <T> List<T> getPageColumnObjList(String tableName, String rowKey, Integer pageNo, Integer pageSize, Class<? extends T> clazz) {
        HTable hTable = null;
        List<T> dataList = new ArrayList<>();
        try {
            hTable = (HTable) HBaseFactoryBean.getDefaultConnection().getTable(tableName);
    ...
    public boolean put(String tableName, String rowKey, List<ColumnInfo> columnInfos) {
        ...
        try {
            ...
            for (ColumnInfo columnInfo : columnInfos) {
                put.add(columnInfo.getColumnFamily().getBytes(), columnInfo.getColumn().getBytes(), HBaseUtil.getValueBytes(columnInfo.getValue(), columnInfo.getValueClass()));
            }
            hTable.put(put);
            hTable.flushCommits();
    ...
    public boolean delete(String tableName, String rowKey) {
        ...
        boolean isSuccess = false;
        try {
            htab = (HTable) HBaseFactoryBean.getDefaultConnection().getTable(tableName);
